 ...
 * @param b blue
 */
Color::Color(int _r = 0, int _g = 0, int _b = 0) : r(_r), g(_g), b(_b) {}
 ...
 */
Form::Form(Material _material) : materiau(_material) {}
 ...
 */
Sphere::Sphere(Point3D _center, double _rayon, Material _material) : Form(_material), center(_center), rayon(_rayon) {}
 ...
 * @param _material material
 */
Triangle::Triangle(Point3D _p1, Point3D _p2, Point3D _p3, Material _material) : Form(_material), p1(_p1), p2(_p2), p3(_p3) {}
 ...
 */
Vecteur3D Triangle::getNormal([[maybe_unused]] const Point3D &p) const
{
    // Vectors AB and AC
    Vecteur3D AB = p2 - p1;
    Vecteur3D AC = p3 - p1;
 ...
 * @param _material material
 */
Square::Square(Point3D _p1, Point3D _p2, Point3D _p3, Point3D _p4, Material _material) : Form(_material), p1(_p1), p2(_p2), p3(_p3), p4(_p4) {}
 ...
 */
bool Square::intersection(const Ray &r, double &t) const
{
 ...
 */
Vecteur3D Square::getNormal([[maybe_unused]] const Point3D &p) const
{
 ...
 * @param _material material
 */
Cube::Cube(double _size, const Point3D &_center, Material _material) : Form(_material), size(_size), center(_center)
{
 ...
 */
void Cube::rotateX(double angle, Point3D center)
{
    for (auto t : cube)
    {
 ...
 * @param center center of the cube
 */
void Cube::rotateY(double angle, Point3D center)
{
    for (auto t : cube)
    {
 ...
 * @param center center of the cube
 */
void Cube::rotateZ(double angle, Point3D center)
{
    for (auto t : cube)
    {
 ...
 */
bool Cube::intersection([[maybe_unused]] const Ray &r, [[maybe_unused]] double &t) const
{
    return false;
}
 ...
 * * Default implementation
 */
Vecteur3D Cube::getNormal([[maybe_unused]] const Point3D &p) const
{
    return Vecteur3D();
}
